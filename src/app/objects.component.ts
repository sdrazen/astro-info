...
export class ObjectsComponent implements OnInit {
  ...
  onFirstClick() {
    ...
    this._backendService.getObjects(this.pageIndex, this.itemsPerPage, this._backendService.allObjects, this._backendService.filteredObjects).then(value => this.objects = value);
  }
  ...
  onSearchClick(searchText: string) {
    ...
    this._backendService.getObjectsBySearchCriteria(searchCriteria, this.itemsPerPage, this._backendService.allObjects)
      .then(value => {
        this.pages = this.getArrayOfNumbers(1, this.pagesPerPageset);
        this.pageIndex = 1;
        this.pageSet = 1;
        this.objects = [];
        this.countOfObjects = this._backendService.filteredObjects.length;
        this._backendService.getObjects(this.pageIndex, this.itemsPerPage, this._backendService.allObjects, this._backendService.filteredObjects)
          .then(value => this.objects = value);
      });
